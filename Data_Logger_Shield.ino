...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  DateTime now = rtc.now();
        ...
        String message = "CO2: " + String(co2Value) + " ppm Temp: " + String(tempValue) + " C Rh: " + String(rhValue) + "%" + 
        "     " + String(now.month(), DEC) + String('/') + String(now.day(), DEC) + String('/') + String(now.year(), DEC) + " " + 
        String(" (") + String(daysOfTheWeek[now.dayOfTheWeek()]) + String(") ") + " " + String(now.hour(), DEC) + String(':') + 
        String(now.minute(), DEC) + String(':') + String (now.second(), DEC);
        sendMessage(message);
        Serial.println();
